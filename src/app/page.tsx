    ...
    <div className="container mx-auto px-6">
      ...
      <div className="mb-12">
        <ul className="space-y-2 text-gray-700">
          <li className="flex items-center">
            ...
            Main DHT Network acting as distributed RAM
          </li>
          <li className="flex items-center">
            <div className="w-2 h-2 bg-blue-500 rounded-full mr-3"></div>
            Program Deployment DHT Network for WASM program distribution
          </li>
          <li className="flex items-center">
            <div className="w-2 h-2 bg-blue-500 rounded-full mr-3"></div>
          ...
          <li className="flex items-center">
            <div className="w-2 h-2 bg-blue-500 rounded-full mr-3"></div>
            Overlay Balancing System (OBS) for decentralized load management
          </li>
        </ul>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <TierCard
          ...
          description="Server-class machines in data centers providing 24/7 uninterrupted operation and reliable connectivity."
        />
        <TierCard
          tier="2"
          title="High-Power Consumer Computers"
          description="Desktop PCs and high-performance laptops offering substantial computing power and storage capacity."
        />
        <TierCard
          tier="3"
          title="Mobile Connected Devices"
          description="Smartphones and tablets with constant cellular network connectivity, offering mobility and widespread distribution."
        />
        <TierCard
          tier="4"
          title="Low-Energy Computing Cells"
          description="IoT devices and Raspberry Pi-like computers, providing continuous connectivity with optimized power consumption."
        />
      </div>
    </div>
  </section>
      ...
      <div className="max-w-3xl mx-auto">
        <ul className="space-y-4 text-gray-700">
          <li className="flex items-start">
            ...
            <span>Advanced DHT implementation based on Kademlia protocol</span>
          </li>
          <li className="flex items-start">
            <div className="w-2 h-2 bg-blue-500 rounded-full mr-3 mt-2"></div>
            <span>Optimized WebAssembly runtime for distributed program execution</span>
          </li>
          <li className="flex items-start">
            <div className="w-2 h-2 bg-blue-500 rounded-full mr-3 mt-2"></div>
            <span>Distributed storage engine with UNIX-like file system interface</span>
          </li>
          <li className="flex items-start">
            <div className="w-2 h-2 bg-blue-500 rounded-full mr-3 mt-2"></div>
            <span>Intelligent load balancing through the Overlay Balancing System</span>
          </li>
          <li className="flex items-start">
            <div className="w-2 h-2 bg-blue-500 rounded-full mr-3 mt-2"></div>
            <span>Secure memory encryption for distributed computing</span>
          </li>
        </ul>
      </div>
    </div>
